  ...
  for (var a = 0; a < spaces.length; a++) {  
    ...
    if (spaces[a][0] != null) {
      ...
      /////////////// TEXT COLOR
        ...
        cad += tag[0] + '<div style="' + tag[2] + 'border-radius:' + radioParagraph + 'px;display: inline-block;padding:8px 28px;margin:5px;' + imgg + 'background-color:' + oc[0] + '; color:' + oc[1] + ';width:' + anchodivpercent + ';overflow-wrap: break-word;">' + thsline + '&nbsp;</div>' + tag[1] + '<br>';
        /* -->
